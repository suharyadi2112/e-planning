  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <ul class="d-flex align-items-center">
        ...
        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
            <h6>{{ nameUser }}</h6>
            <span>{{ jabatanUser }} | {{ roleUser }}</span>
            </li>
            <li>
            <hr class="dropdown-divider">
            </li>
            ...
            <li>
                <a class="dropdown-item d-flex align-items-center" href="#" data-bs-toggle="modal" data-bs-target="#modalChangePassword">
...
export default {
    ...
    data() {
        return {
            nameUser: localStorage.getItem('userInfoName'),
            jabatanUser: localStorage.getItem('userInfoJabatan'),
            roleUser: localStorage.getItem('userInfoRole'),
        }
    },
    methods: {
        toggleSidebar() {
            ...
            try {
                ...
                if (result.isConfirmed) {
                    ...
                    if (response.status === 200 && response.data.status === 'success') {
                        ...
                        this.Toasttt('Logout Success', 'success');
                        this.$router.push('/login');
                    } else {
                        this.Toasttt('Logout failed.', 'error');
        ...
        removeDataLocalStorage() {
            localStorage.removeItem('tokenCallIT');//token
            for (let key in localStorage) {
                if (Object.prototype.hasOwnProperty.call(localStorage, key) && key.startsWith("user")) {
                    localStorage.removeItem(key);//user data
                }
            }
        },
