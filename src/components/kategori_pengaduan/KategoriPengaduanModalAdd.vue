<!-- ModalFormAddKategoriPengaduan -->
<template>
    <div class="modal fade" id="modalKategoriPengaduan" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog ">
        <div class="modal-content">
          <div class="modal-header bg-primary">
            <h1 class="modal-title fs-5 text-white" id="staticBackdropLabel">Adding Kategori</h1>
          ...
          <form @submit.prevent="submitFormKategoriPengaduan">
            ...
            <div class="modal-footer">
              ...
              <button class="btn btn-primary" style="float: right;" type="submit" :disabled="loadingSubmitKatPeng">
                <span v-if="!loadingSubmitKatPeng"><i class="bi bi-arrow-repeat"></i> Submit Kategori Pengaduan</span>
                <span v-else>
                  <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                  <label> Submit Kategori Pengaduan</label>
                </span>
              </button>
            </div>
        </form>
    ...
    methods: {
      submitFormKategoriPengaduan() {
        ...
        requiredFields.forEach(field => { 
          ...
          if (!this.formData[field]) {
            ...
            setTimeout(()=>{ this.loadingSubmitKatPeng = false },1000);
          }else{
      ...
      async sendStoreKategoriPengaduan() {
        try {
            ...
            this.Toasttt('Successfully', 'success', 'Data Kategori Pengaduan Successfully Stored')
            this.$emit('katpengAdd'); //sent signal to views
            this.errorMessages = [];
            return response
          ...
          this.loadingSubmitKatPeng = false
        }
      },
