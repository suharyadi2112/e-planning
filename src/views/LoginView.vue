            ...
            <section class="section register min-vh-100 d-flex flex-column align-items-center justify-content-center py-4">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="d-flex justify-content-center py-4">
                        ...
                        <img src="assets/img/callit.png" alt="" style="width: 100%; text-align: center">
                        </a>
                    </div><!-- End Logo -->
        ...
        async login() {
            try {
                ...
                if (token) {
                    ...
                    localStorage.setItem('tokenCallIT', token);
                    for (const key in userInfo) { //user data
                        localStorage.setItem(`userInfo${key.charAt(0).toUpperCase()}${key.slice(1)}`, userInfo[key]);
                    }
